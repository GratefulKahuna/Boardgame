...
var tile_dict = {
	...
	"Jeweler2": 3 + randi_range(1, 2),
	"Diamond_dealer": 5 + randi_range(1, 2),
	"Diamond_dealer2": 5 + randi_range(1, 2),
	"Hotel": 3 + randi_range(1, 2),
	"Hotel2": 3 + randi_range(1, 2),
	"Bank": 3 + randi_range(1, 2),
	"Bank2": 3 + randi_range(1, 2),
	"Gallery": 5 + randi_range(1, 2),
	"Gallery2": 5 + randi_range(1, 2),
	"Police_station": 3 + randi_range(1, 2),
	"Police_station2": 3 + randi_range(1, 2),
	"Gold_dealer": 5 + randi_range(1, 2),
	"Gold_dealer2": 5 + randi_range(1, 2),
